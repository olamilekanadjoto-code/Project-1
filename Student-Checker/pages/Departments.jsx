        ...
        <div className="dept-grid">
          <div className="dept-box">
            ...
            <span
              ...
              style={{ transform: `translateX(-${medCurrent * 100}%)` }}
            >
            ...
            <p className="description">
              Medical Sciences focuses on understanding the human body, health,
              disease, and the scientific principles behind diagnosis,
          ...
          <div className="dept-grid">
            <div className="dept-box">
              ...
              <span
                className="slider-image"
                style={{ transform: `translateX(-${commCurrent * 100}%)` }}
              >
              ...
              <p className="description">
                Commercial Studies focuses on the principles and practices
                involved in business, trade, finance, and economic activity.
              </p>
            </div>
          </div>
          <div className="dept-grid">
            <div className="dept-box">
              ...
              <span
                className="slider-image"
                style={{ transform: `translateX(-${lawCurrent * 100}%)` }}
              >
            ...
            <p className="description">
              Law and Humanities examines the systems, principles, and ideas
              that shape human society and relationships.
            </p>
          </div>
          <div className="dept-grid">
            <div className="dept-box">
              ...
              <span
                className="slider-image"
                style={{ transform: `translateX(-${appCurrent * 100}%)` }}
              >
            ...
            <p className="description">
              Applied Sciences focuses on using scientific knowledge to solve
              practical problems and develop useful solutions.
            </p>
          </div>
          <div className="dept-grid">
            <div className="dept-box">
              ...
              <span
                className="slider-image"
                style={{ transform: `translateX(-${langCurrent * 100}%)` }}
              >
              ...
              <p className="description">
                Languages and Linguistics focuses on the structure, development,
                use, and communication of human language.
              </p>
            </div>
          </div>
        </div>
